use crate::application::dto::project_user_dto::{
    AddMemberRequest, AddMemberResponse, BatchRoleAssignmentResponse, FailedAssignment,
    MembershipResponse, ProjectMembersResponse, RemoveMemberResponse, RoleAssignmentResponse,
    ...
    D: ProjectDataService,
{
    ...
    pub async fn batch_assign_roles(
        ...
        Ok(BatchRoleAssignmentResponse {
            message: format!(
                "Batch role assignment completed. {} successful, {} failed",
                assigned_count,
